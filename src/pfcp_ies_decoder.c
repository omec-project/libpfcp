        ...
        pfcp_trnspt_lvl_marking_ie_t *value)
{
    uint16_t total_decoded = 0;
    total_decoded += decode_pfcp_ie_header_t(buf + (total_decoded/CHAR_SIZE), &value->header);
    memcpy(value->tostraffic_cls, buf + total_decoded, sizeof(value->tostraffic_cls));
    total_decoded += sizeof(value->tostraffic_cls);
    return value->header.len + PFCP_IE_HEADER_SIZE;
}
		...
		pfcp_failed_rule_id_ie_t *value)
{
	...
	if (value->rule_id_type == 0) {
		value->rule_id_value = decode_bits(buf, total_decoded, 16, &decoded);
		total_decoded += decoded;
	} else if (value->rule_id_type == 4) {
		value->rule_id_value = decode_bits(buf, total_decoded, 8, &decoded);
		total_decoded += decoded;
	} else {
		value->rule_id_value = decode_bits(buf, total_decoded, 32, &decoded);
		total_decoded += decoded;
	}
	return value->header.len + PFCP_IE_HEADER_SIZE;
}
        ...
        pfcp_mac_addrs_detctd_ie_t *value)
{
    ...
    value->nbr_of_mac_addrs = decode_bits(buf, total_decoded, 8, &decoded);
    total_decoded += decoded;
    memcpy(&value->mac_addr_val, buf + (total_decoded/CHAR_SIZE), 6 * value->nbr_of_mac_addrs);
    total_decoded +=  6 * CHAR_SIZE;
    return value->header.len + PFCP_IE_HEADER_SIZE;
}
        ...
        pfcp_usage_info_ie_t *value)
{
    ...
    total_decoded += decode_pfcp_ie_header_t(buf + (total_decoded/CHAR_SIZE), &value->header);
    uint16_t decoded = 0;
    value->usage_info_spare = decode_bits(buf, total_decoded, 4, &decoded);
    total_decoded += decoded;
		...
		pfcp_application_id_ie_t *value)
{
	uint16_t total_decoded = 0;
	total_decoded += decode_pfcp_ie_header_t(buf + (total_decoded/CHAR_SIZE), &value->header);
	if (value->header.len > sizeof(value->app_ident))
	value->header.len = sizeof(value->app_ident);
	/* TODO: Revisit this for change in yang */
	memcpy(&value->app_ident, buf + (total_decoded/CHAR_SIZE), value->header.len);
        ...
        pfcp_ue_ip_address_ie_t *value)
{
    ...
    DECODE_IPV6_ADDRESS_COND_6(buf, total_decoded, 128, decoded, value);
	/* TODO: Revisit this for change in yang */
        ...
        pfcp_pfd_contents_ie_t *value)
{
	...
	total_decoded += decode_pfcp_ie_header_t(buf + (total_decoded/CHAR_SIZE), &value->header);
	uint16_t decoded = 0;
	value->adnp = decode_bits(buf, total_decoded, 1, &decoded); total_decoded += decoded;
	value->aurl = decode_bits(buf, total_decoded, 1, &decoded); total_decoded += decoded;
	value->afd = decode_bits(buf, total_decoded, 1, &decoded);  total_decoded += decoded;
	value->dnp = decode_bits(buf, total_decoded, 1, &decoded);  total_decoded += decoded;
	value->cp = decode_bits(buf, total_decoded, 1, &decoded);   total_decoded += decoded;
	value->dn = decode_bits(buf, total_decoded, 1, &decoded);   total_decoded += decoded;
	value->url = decode_bits(buf, total_decoded, 1, &decoded);  total_decoded += decoded;
	value->fd = decode_bits(buf, total_decoded, 1, &decoded);   total_decoded += decoded;
	...
	if (value->fd) {
		...
		total_decoded += decoded;
		memcpy(&value->data[ofs], buf + (total_decoded/CHAR_SIZE), value->len_of_flow_desc);
		value->flow_desc = &value->data[ofs];
		total_decoded += value->len_of_flow_desc * CHAR_SIZE;
		ofs += value->len_of_flow_desc;
	}
	if (value->url) {
		value->length_of_url = decode_bits(buf, total_decoded, 16, &decoded);
		total_decoded += decoded;
		memcpy(&value->data[ofs], buf + (total_decoded/CHAR_SIZE), value->length_of_url);
		value->url2 = &value->data[ofs];
		total_decoded += value->length_of_url * CHAR_SIZE;
		ofs += value->length_of_url;
	}
	if (value->dn) {
		value->len_of_domain_nm = decode_bits(buf, total_decoded, 16, &decoded);
		total_decoded += decoded;
		memcpy(&value->data[ofs], buf + (total_decoded/CHAR_SIZE), value->len_of_domain_nm);
		value->domain_name = &value->data[ofs];
		total_decoded += value->len_of_domain_nm * CHAR_SIZE;
		ofs += value->len_of_domain_nm;
	}
	if (value->cp) {
		value->len_of_cstm_pfd_cntnt = decode_bits(buf, total_decoded, 16, &decoded);
		total_decoded += decoded;
		memcpy(&value->data[ofs], buf + (total_decoded/CHAR_SIZE), value->len_of_cstm_pfd_cntnt);
		value->cstm_pfd_cntnt = &value->data[ofs];
		total_decoded += value->len_of_cstm_pfd_cntnt * CHAR_SIZE;
		ofs += value->len_of_cstm_pfd_cntnt;
	}
	if (value->dnp) {
		value->len_of_domain_nm_prot = decode_bits(buf, total_decoded, 16, &decoded);
		total_decoded += decoded;
		memcpy(&value->data[ofs], buf + (total_decoded/CHAR_SIZE), value->len_of_domain_nm_prot);
		value->domain_name_prot = &value->data[ofs];
		total_decoded += value->len_of_domain_nm_prot * CHAR_SIZE;
		ofs += value->len_of_domain_nm_prot;
	}
	if (value->afd) {
		value->len_of_add_flow_desc = decode_bits(buf, total_decoded, 16, &decoded);
		total_decoded += decoded;
		memcpy(&value->data[ofs], buf + (total_decoded/CHAR_SIZE), value->len_of_add_flow_desc);
		value->add_flow_desc = &value->data[ofs];
		total_decoded += value->len_of_add_flow_desc * CHAR_SIZE;
		ofs += value->len_of_add_flow_desc;
	}
	if (value->aurl) {
		value->len_of_add_url = decode_bits(buf, total_decoded, 16, &decoded);
		total_decoded += decoded;
		memcpy(&value->data[ofs], buf + (total_decoded/CHAR_SIZE), value->len_of_add_url);
		value->add_url = &value->data[ofs];
		total_decoded += value->len_of_add_url * CHAR_SIZE;
		ofs += value->len_of_add_url;
	}
	if (value->adnp) {
		value->len_of_add_domain_nm_prot = decode_bits(buf, total_decoded, 16, &decoded);
		total_decoded += decoded;
		memcpy(&value->data[ofs], buf + (total_decoded/CHAR_SIZE), value->len_of_add_domain_nm_prot);
		value->add_domain_nm_prot = &value->data[ofs];
		total_decoded += value->len_of_add_domain_nm_prot * CHAR_SIZE;
		ofs += value->len_of_add_domain_nm_prot;
	}
        ...
        pfcp_packet_rate_ie_t *value)
{
    ...
    if (value->ulpr) {
        ...
        total_decoded += decoded;
        value->max_uplnk_pckt_rate = decode_bits(buf, total_decoded, 16, &decoded);
        total_decoded += decoded;
    }
    ...
    if (value->dlpr) {
        ...
        total_decoded += decoded;
        value->max_dnlnk_pckt_rate = decode_bits(buf, total_decoded, 16, &decoded);
        total_decoded += decoded;
    }
        ...
        pfcp_hdr_enrchmt_ie_t *value)
{
    ...
    total_decoded += decoded;
    if (value->len_of_hdr_fld_nm > 0) {
        decoded = value->len_of_hdr_fld_nm > sizeof(value->hdr_fld_nm) ?
            sizeof(value->hdr_fld_nm) : value->len_of_hdr_fld_nm;
        memcpy(value->hdr_fld_nm, buf + (total_decoded*CHAR_SIZE), decoded);
        total_decoded += value->len_of_hdr_fld_nm * CHAR_SIZE;
        value->len_of_hdr_fld_nm = decoded;
    }
    value->len_of_hdr_fld_val = decode_bits(buf, total_decoded, 8, &decoded);
    total_decoded += decoded;
    if (value->len_of_hdr_fld_val > 0) {
        decoded = value->len_of_hdr_fld_val > sizeof(value->hdr_fld_val) ?
            sizeof(value->hdr_fld_val) : value->len_of_hdr_fld_val;
        memcpy(value->hdr_fld_val, buf + (total_decoded*CHAR_SIZE), decoded);
        total_decoded += value->len_of_hdr_fld_val * CHAR_SIZE;
        value->len_of_hdr_fld_val = decoded;
    }
        ...
        pfcp_fteid_ie_t *value)
{
	...
	DECODE_IPV6_ADDRESS_COND_5(buf, total_decoded, 128, decoded, value);
        ...
        pfcp_up_func_feat_ie_t *value)
{
    ...
    value->sup_feat.treu = decode_bits(buf, total_decoded, 1, &decoded);     total_decoded += decoded;
    value->sup_feat.heeu = decode_bits(buf, total_decoded, 1, &decoded);     total_decoded += decoded;
    value->sup_feat.pfdm = decode_bits(buf, total_decoded, 1, &decoded);     total_decoded += decoded;
    value->sup_feat.ftup = decode_bits(buf, total_decoded, 1, &decoded);     total_decoded += decoded;
    value->sup_feat.trst = decode_bits(buf, total_decoded, 1, &decoded);     total_decoded += decoded;
    value->sup_feat.dlbd = decode_bits(buf, total_decoded, 1, &decoded);     total_decoded += decoded;
    value->sup_feat.ddnd = decode_bits(buf, total_decoded, 1, &decoded);     total_decoded += decoded;
    value->sup_feat.bucp = decode_bits(buf, total_decoded, 1, &decoded);     total_decoded += decoded;

    value->sup_feat.spare = decode_bits(buf, total_decoded, 1, &decoded);    total_decoded += decoded;
    value->sup_feat.pfde = decode_bits(buf, total_decoded, 1, &decoded);     total_decoded += decoded;
    value->sup_feat.frrt = decode_bits(buf, total_decoded, 1, &decoded);     total_decoded += decoded;
    value->sup_feat.trace = decode_bits(buf, total_decoded, 1, &decoded);    total_decoded += decoded;
    value->sup_feat.quoac = decode_bits(buf, total_decoded, 1, &decoded);    total_decoded += decoded;
    value->sup_feat.udbc = decode_bits(buf, total_decoded, 1, &decoded);     total_decoded += decoded;
    value->sup_feat.pdiu = decode_bits(buf, total_decoded, 1, &decoded);     total_decoded += decoded;
    value->sup_feat.empu = decode_bits(buf, total_decoded, 1, &decoded);     total_decoded += decoded;
        ...
        pfcp_event_quota_ie_t *value)
{
    ...
    total_decoded += decode_pfcp_ie_header_t(buf + (total_decoded/CHAR_SIZE), &value->header);
    uint16_t decoded = 0;
    value->event_quota = decode_bits(buf, total_decoded, 32, &decoded);
    total_decoded += decoded;
    return value->header.len + PFCP_IE_HEADER_SIZE;
}
        ...
        pfcp_flow_info_ie_t *value)
{
    ...
    value->len_of_flow_desc = decode_bits(buf, total_decoded, 16, &decoded);
    total_decoded += decoded;
    decoded = value->len_of_flow_desc > sizeof(value->flow_desc)
        ? sizeof(value->flow_desc) : value->len_of_flow_desc;
    memcpy(value->flow_desc, buf + (total_decoded/CHAR_SIZE), decoded);
    value->len_of_flow_desc = decoded;
    total_decoded += decoded * CHAR_SIZE;
    return value->header.len + PFCP_IE_HEADER_SIZE;
}
        ...
        pfcp_ntwk_inst_ie_t *value)
{
    uint16_t total_decoded = 0;
    total_decoded += decode_pfcp_ie_header_t(buf + (total_decoded/CHAR_SIZE), &value->header);
    memcpy(&value->ntwk_inst, buf + (total_decoded/CHAR_SIZE), value->header.len);

    total_decoded += value->header.len * CHAR_SIZE;//decoded;
    return value->header.len + PFCP_IE_HEADER_SIZE;
}
        ...
        pfcp_redir_info_ie_t *value)
{
    ...
    total_decoded += decoded;
    value->redir_svr_addr_len = decode_bits(buf, total_decoded, 16, &decoded);
    total_decoded += decoded;
    if (value->redir_svr_addr_len > sizeof(value->redir_svr_addr))
        value->redir_svr_addr_len = sizeof(value->redir_svr_addr);
    memcpy(value->redir_svr_addr, buf + total_decoded, value->redir_svr_addr_len);
    total_decoded += value->redir_svr_addr_len * CHAR_SIZE;
    value->other_redir_svr_addr_len = decode_bits(buf, total_decoded, 16, &decoded);
    total_decoded += decoded;
    if (value->other_redir_svr_addr_len > sizeof(value->other_redir_svr_addr))
        value->other_redir_svr_addr_len = sizeof(value->other_redir_svr_addr);
    memcpy(value->other_redir_svr_addr, buf + total_decoded, value->other_redir_svr_addr_len);
    total_decoded += value->other_redir_svr_addr_len * CHAR_SIZE;
        ...
        pfcp_app_inst_id_ie_t *value)
{
    uint16_t total_decoded = 0;
    total_decoded += decode_pfcp_ie_header_t(buf + (total_decoded/CHAR_SIZE), &value->header);
    uint16_t decoded = value->header.len > sizeof(value->app_inst_ident)
        ? sizeof(value->app_inst_ident) : value->header.len;
    memcpy(value->app_inst_ident, buf + (total_decoded/CHAR_SIZE), decoded);
    total_decoded += decoded * CHAR_SIZE;
    return value->header.len + PFCP_IE_HEADER_SIZE;
}
        ...
        pfcp_frmd_ipv6_rte_ie_t *value)
{
    ...
    memcpy(value->frmd_ipv6_rte,buf + (total_decoded/CHAR_SIZE), value->header.len * CHAR_SIZE);
    total_decoded += value->header.len * CHAR_SIZE;
    return value->header.len + PFCP_IE_HEADER_SIZE;
}
        ...
        pfcp_outer_hdr_removal_ie_t *value)
{
    ...
    total_decoded += decoded;
    if (total_decoded/CHAR_SIZE < (value->header.len + sizeof(value->header))) {
        memcpy(&value->gtpu_ext_hdr_del, buf + (total_decoded*CHAR_SIZE), sizeof(value->gtpu_ext_hdr_del));
        total_decoded += sizeof(value->gtpu_ext_hdr_del) * CHAR_SIZE;
    }
    return value->header.len + PFCP_IE_HEADER_SIZE;
}
        ...
        pfcp_dl_buf_suggstd_pckt_cnt_ie_t *value)
{
    ...
    total_decoded += decode_pfcp_ie_header_t(buf + (total_decoded/CHAR_SIZE), &value->header);
    uint16_t decoded = 0;
    value->pckt_cnt_val = decode_bits(buf, total_decoded, value->header.len * CHAR_SIZE, &decoded);
    total_decoded += decoded;
    return value->header.len + PFCP_IE_HEADER_SIZE;
}
		...
		pfcp_user_plane_ip_rsrc_info_ie_t *value)
{
	...
	/* TODO: Revisit this for change in yang */
	DECODE_IPV6_ADDRESS_COND_4(buf, total_decoded, 128, decoded, value);
        ...
        pfcp_cp_func_feat_ie_t *value)
{
    ...
    total_decoded += decode_pfcp_ie_header_t(buf + (total_decoded/CHAR_SIZE), &value->header);
    uint16_t decoded = 0;
    value->sup_feat.cp_func_feat_spare = decode_bits(buf, total_decoded, 6, &decoded);
    total_decoded += decoded;
    value->sup_feat.ovrl = decode_bits(buf, total_decoded, 1, &decoded);
    total_decoded += decoded;
    value->sup_feat.load = decode_bits(buf, total_decoded, 1, &decoded);
    total_decoded += decoded;
    return value->header.len + PFCP_IE_HEADER_SIZE;
}
        ...
        pfcp_framed_route_ie_t *value)
{
    ...
    memcpy(value->framed_route, buf + (total_decoded/CHAR_SIZE), value->header.len);
    total_decoded += value->header.len * CHAR_SIZE;
    return value->header.len + PFCP_IE_HEADER_SIZE;
}
        ...
        pfcp_trc_info_ie_t *value)
{
    ...
    total_decoded += decoded;
    decoded = value->len_of_trigrng_evnts > sizeof(value->trigrng_evnts) ?
        sizeof(value->trigrng_evnts) : value->len_of_trigrng_evnts;
    memcpy(value->trigrng_evnts, buf + (total_decoded/CHAR_SIZE), decoded);
    value->len_of_trigrng_evnts = decoded;
    total_decoded += decoded * CHAR_SIZE;
    ...
    total_decoded += decoded;
    decoded = value->len_of_list_of_intfcs > sizeof(value->list_of_intfcs) ?
        sizeof(value->list_of_intfcs) : value->len_of_list_of_intfcs;
    memcpy(value->list_of_intfcs, buf + (total_decoded/CHAR_SIZE), decoded);
    value->len_of_list_of_intfcs = decoded;
    total_decoded += decoded * CHAR_SIZE;

    value->len_of_ip_addr_of_trc_coll_ent = decode_bits(buf, total_decoded, 8, &decoded);
    total_decoded += decoded;
    decoded = value->len_of_ip_addr_of_trc_coll_ent > sizeof(value->ip_addr_of_trc_coll_ent) ?
        sizeof(value->ip_addr_of_trc_coll_ent) : value->len_of_ip_addr_of_trc_coll_ent;
    memcpy(value->ip_addr_of_trc_coll_ent, buf + (total_decoded/CHAR_SIZE), decoded);
    value->len_of_ip_addr_of_trc_coll_ent = decoded;
    total_decoded += decoded * CHAR_SIZE;
    return value->header.len + PFCP_IE_HEADER_SIZE;
}
        ...
        pfcp_add_usage_rpts_info_ie_t *value)
{
    ...
    total_decoded += decoded;
    value->nbr_of_add_usage_rpts_val = decode_bits(buf, total_decoded, 15, &decoded);
    total_decoded += decoded;
    return value->header.len + PFCP_IE_HEADER_SIZE;
}
        ...
        pfcp_outer_hdr_creation_ie_t *value)
{
    ...
    total_decoded += decode_pfcp_ie_header_t(buf + (total_decoded/CHAR_SIZE), &value->header);
    uint16_t decoded = 0;
    value->outer_hdr_creation_desc.stag = decode_bits(buf, total_decoded, 1, &decoded);             total_decoded += decoded;
    value->outer_hdr_creation_desc.ctag = decode_bits(buf, total_decoded, 1, &decoded);             total_decoded += decoded;
    value->outer_hdr_creation_desc.ipv6 = decode_bits(buf, total_decoded, 1, &decoded);             total_decoded += decoded;
    value->outer_hdr_creation_desc.ipv4 = decode_bits(buf, total_decoded, 1, &decoded);             total_decoded += decoded;
    value->outer_hdr_creation_desc.udp_ipv6 = decode_bits(buf, total_decoded, 1, &decoded);         total_decoded += decoded;
    value->outer_hdr_creation_desc.udp_ipv4 = decode_bits(buf, total_decoded, 1, &decoded);         total_decoded += decoded;
    value->outer_hdr_creation_desc.gtpu_udp_ipv6 = decode_bits(buf, total_decoded, 1, &decoded);    total_decoded += decoded;
    value->outer_hdr_creation_desc.gtpu_udp_ipv4 = decode_bits(buf, total_decoded, 1, &decoded);    total_decoded += decoded;

    value->outer_hdr_creation_desc.spare8 = decode_bits(buf, total_decoded, 1, &decoded);           total_decoded += decoded;
    value->outer_hdr_creation_desc.spare7 = decode_bits(buf, total_decoded, 1, &decoded);           total_decoded += decoded;
    value->outer_hdr_creation_desc.spare6 = decode_bits(buf, total_decoded, 1, &decoded);           total_decoded += decoded;
    value->outer_hdr_creation_desc.spare5 = decode_bits(buf, total_decoded, 1, &decoded);           total_decoded += decoded;
    value->outer_hdr_creation_desc.spare4 = decode_bits(buf, total_decoded, 1, &decoded);           total_decoded += decoded;
    value->outer_hdr_creation_desc.spare3 = decode_bits(buf, total_decoded, 1, &decoded);           total_decoded += decoded;
    value->outer_hdr_creation_desc.spare2 = decode_bits(buf, total_decoded, 1, &decoded);           total_decoded += decoded;
    value->outer_hdr_creation_desc.spare1 = decode_bits(buf, total_decoded, 1, &decoded);           total_decoded += decoded;
    ...
    DECODE_IPV6_ADDRESS_COND_3(buf, total_decoded, 128, decoded, value);
		...
		pfcp_fseid_ie_t *value)
{
	...
	DECODE_IPV6_ADDRESS_COND_2(buf, total_decoded, 128, decoded, value);
        ...
        pfcp_rmt_gtpu_peer_ie_t *value)
{
    ...
    total_decoded += decode_pfcp_ie_header_t(buf + (total_decoded/CHAR_SIZE), &value->header);
    uint16_t decoded = 0;
    value->rmt_gtpu_peer_spare = decode_bits(buf, total_decoded, 4, &decoded);
    total_decoded += decoded;
    value->ni = decode_bits(buf, total_decoded, 1, &decoded);
    total_decoded += decoded;
    value->di = decode_bits(buf, total_decoded, 1, &decoded);
    total_decoded += decoded;
    value->v4 = decode_bits(buf, total_decoded, 1, &decoded);
    total_decoded += decoded;
    value->v6 = decode_bits(buf, total_decoded, 1, &decoded);
    ...
    DECODE_IPV6_ADDRESS_COND_1(buf, total_decoded, 128, decoded, value);
    DECODE_DST_INTFC_COND_1(buf, total_decoded, len_of_dst_intfc_fld * CHAR_SIZE, decoded, value);
    DECODE_NTWK_INSTC_COND_1(buf, total_decoded, len_of_ntwk_instc_fld * CHAR_SIZE, decoded, value);
    total_decoded += decoded;
    return value->header.len + PFCP_IE_HEADER_SIZE;
}
