...
#define IE_UPDATE_BAR_SESS_RPT_RESP (12)
...
typedef struct pfcp_dnlnk_data_rpt_ie_t {
  ...
  uint8_t dnlnk_data_svc_info_count;
  pfcp_dnlnk_data_svc_info_ie_t dnlnk_data_svc_info[MAX_LIST_SIZE];
...
typedef struct pfcp_pdi_ie_t {
	...
	uint8_t frmd_ipv6_rte_count;
	pfcp_frmd_ipv6_rte_ie_t frmd_ipv6_rte[MAX_LIST_SIZE];
	pfcp_3gpp_intfc_type_ie_t src_intrc_type;
} pfcp_pdi_ie_t;
...
typedef struct pfcp_sess_estab_rsp_t {
  ...
  pfcp_created_pdr_ie_t created_pdr[MAX_LIST_SIZE];
  uint8_t created_traffic_endpt_count;
  pfcp_created_traffic_endpt_ie_t created_traffic_endpt[MAX_LIST_SIZE];
